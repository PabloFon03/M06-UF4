...
def InitDB():
    sql.CreateTable("users", "id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name VARCHAR(64), surname VARCHAR(64), username VARCHAR(64), password VARCHAR(64), admin BIT")
    if not User.UserExists(User, "admin", "1234", sql):
        User(None, "", "", "admin", "1234", True).Add(sql)
